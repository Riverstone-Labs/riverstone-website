        ...
        >
          {serviceCards.map((card, index) => (
            <StaggerItem key={index}>
              <div className="group h-full bg-[#0a0a0a] rounded-lg p-8 border border-gray-800 transition-all duration-300 hover:border-[#3b82f6]/50 hover:bg-[#0f0f0f]">
                {/* Icon */}
                <div className="w-12 h-12 rounded-lg bg-[#3b82f6]/10 border border-[#3b82f6]/30 flex items-center justify-center mb-6 group-hover:bg-[#3b82f6]/20 transition-colors duration-300">
